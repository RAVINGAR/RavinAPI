...
public class PageIcon extends BaseIcon {
    public PageIcon(final String identifier, final String display, final String lore, final String parent, final Material material, final BiPredicate<BaseGui, Player> predicate, final Consumer<ItemStack> consumer) {
